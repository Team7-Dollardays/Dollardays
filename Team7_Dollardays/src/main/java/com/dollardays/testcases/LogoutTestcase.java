...
public class LogoutTestcase  extends BaseTest{
	...
	public void logout_HomePage(Hashtable<String, String> datatable) throws Exception{
		String actualText = "";
		String expectedText = "";
	...
	@DDDataProvider(datafile = "testdata/testdata.xlsx", sheetName = "Logout",  testcaseID = "TC2", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class)
	public void logout_AccountPage(Hashtable<String, String> datatable) throws Exception{
		String actualText = "";
		String expectedText = "";
		System.out.println(datatable.get("TestCase"));
		ExtentTestManager.getTest().log(Status.INFO,
